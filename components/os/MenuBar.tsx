...
export function MenuBar({ dateStr, timeStr }: MenuBarProps) {
  return (
    <div className="absolute top-0 left-0 right-0 h-[26px] bg-[rgba(5,10,18,0.7)] backdrop-blur-xl border-b border-white/6 flex items-center justify-between px-4 z-[9999]">
