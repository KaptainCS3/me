    ...
    <div className="h-full flex flex-col font-mono text-sm bg-[#06090c] overflow-hidden select-none">
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 pb-16 sm:pb-24 space-y-8 custom-scrollbar">
        ...
        <section className="space-y-1">
          <p className="text-[#4a6b7a] text-xs">
            // System capability matrix — high priority modules
          </p>
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-[10px] text-[#4a6b7a] font-bold uppercase tracking-widest leading-none mb-1">
                    Module 0{idx + 1}
                  </h3>
                  <h4 className="text-xs text-white font-bold truncate uppercase">
                    {s.cat}
                  </h4>
                </div>
              </div>
              ...
              <div className="space-y-2">
                {s.items.map((item) => (
                  ...
                  >
                    <FiChevronRight
                      size={10}
                      className="text-[#34d399] opacity-30 group-hover/item:opacity-100 transition-opacity"
                    />
                    <span className="text-[11px] text-[#a8c4d0] group-hover/item:text-white transition-colors">
                      {item}
                    </span>
                  </div>
                ))}
      ...
      <div className="flex items-center bg-[#0d1117] border-t border-[#1e3a4a]/30 h-8 text-[10px] overflow-hidden shrink-0">
        ...
        <div className="flex items-center gap-4 text-[#4a6b7a]">
          ...
          <span className="hidden sm:inline opacity-50 italic tracking-wider uppercase">
            Runtime: Production
          </span>
        </div>
      </div>
